...
class WhatsAppSenderApp:
    ...
    def load_template(self):
        ...
        if t == "rma":
            self.msg_text.insert('1.0', "🚨 URGENT REMINDER 🚨\n\n"
                "Important reminder that the RMA, XBM & TRADE-IN shipments listed "
                "are still pending and are approaching the deadline ⏳\n\n"
                "⚠️ Delayed shipment may result in chargebacks...\n\n✨")
