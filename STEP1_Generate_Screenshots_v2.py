...
#     # group_map key: whatsapp_group_name
#     # group_map value: {
#     #     'rows': [row numbers],
#     #     'market': market name,
#     #     'districts': set of districts,
#     #     'dms': set of DM names,
#     #     'send_mode': 'tag_all_dms' or 'send_to_group' or 'send_to_both_groups',
#     #     'merge_key': optional merge key for special handling
#     # }
#     group_map = {}
#     row_errors = []
...
#     # Export full reminder columns: A through V
...
#             # Try to find phone number and dmNameRep from loaded contacts
#             phone = None
#             dm_name_rep = None
            
#             for market in markets_in_group:
#                 if market in dm_contacts and dm_name in dm_contacts[market]:
#                     contact_info = dm_contacts[market][dm_name]
